...
namespace
{
    constexpr char licenseKey[] = "";
...
bool AppController::createObservers()
{
    ...
    if (mTarget == IMAGE_TARGET_ID)
    {
        ...
        string targetName[] = {"001","002","003","004","005","006","007"};


        for (int i = 0; i < targetName->length(); ++i) {
            auto imageTargetConfig = vuImageTargetConfigDefault();
            imageTargetConfig.databasePath = "BYQ.xml";
            imageTargetConfig.targetName = targetName[i].data();
      ...
      /*  auto imageTargetConfig2 = vuImageTargetConfigDefault();
        imageTargetConfig2.databasePath = "BYQ.xml";
        imageTargetConfig2.targetName = "BYQ32";
        imageTargetConfig2.activate = VU_TRUE;

        VuImageTargetCreationError imageTargetCreationError2;
        if (vuEngineCreateImageTargetObserver(mEngine, &mObjectObserver, &imageTargetConfig2, &imageTargetCreationError2) != VU_SUCCESS)
        {
            LOG("Error creating image target observer: 0x%02x", imageTargetCreationError2);
            mShowErrorCallback("Error creating image target observer");
            return false;
        }*/
