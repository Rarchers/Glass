...
* encording init
*/
JNIEXPORT jint JNICALL Java_com_example_glass_component_video_Ffmpeg_videoinit(JNIEnv * env, jclass obj)
{
    if(isStart)
        return -1;
...
JNIEXPORT jbyteArray JNICALL Java_com_example_glass_component_video_Ffmpeg_videoencode(JNIEnv * env, jclass obj,jbyteArray yuvdata)
{
...
JNIEXPORT jint JNICALL Java_com_example_glass_component_video_Ffmpeg_videoclose(JNIEnv * env, jclass obj)
{
    if(!isStart)
        return -1;
     LOGE("zsg:  tag1");
...
JNIEXPORT jbyteArray JNICALL Java_com_example_glass_component_video_Ffmpeg_videodecode
