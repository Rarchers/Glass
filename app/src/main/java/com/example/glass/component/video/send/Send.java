package com.example.glass.component.video.send;
    ...
    public void doStart(View v) {
        ...
        if (rtp_socket == null) {
            try {
                ...
                //设定套接字
                rtp_socket = new RtpSocket(new SipdroidSocket(Config.sendPort), InetAddress.getByName(Config.remoteIP), Config.receivePort);
