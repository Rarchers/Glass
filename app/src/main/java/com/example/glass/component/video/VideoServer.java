...
import com.example.glass.component.video.receive.Receive;
import com.example.glass.component.video.send.Send;
...
public class VideoServer {
    ...
    public void initServer() {
        ...
        try {
            ...
            rtp_socket = new RtpSocket(new SipdroidSocket(20000), InetAddress.getByName(Config.remoteIP),server_video_port);
            //doStart();
