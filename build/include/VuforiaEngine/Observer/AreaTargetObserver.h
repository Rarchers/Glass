...
/// \brief Set approximate 2D position within an Area Target target from an external localization source (DEPRECATED)
/**
 ...
 * this method or any of the other vuAreaTargetObserverSetExternalPosition
...
/// \brief Set approximate 2D position within an Area Target target from an external localization source
/**
 * Setting up the external position only succeeds when the target is activated.
 *
 * \note The provided external position is valid until a successful localization,
...
/// \brief Set approximate 3D position within an Area Target target from an external localization source
/**
 * Setting up the external position only succeeds when the target is activated.
 *
 * \note The provided external position is valid until a successful localization,
