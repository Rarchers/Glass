...
/**
 * \note A static device tracker can only be created when Vuforia is not running. Creating it when Vuforia is running will return an error.
 */
 ...
 *
 * \note This method can only be called when Vuforia is not running. Calling it when Vuforia is running will return an error.
 */
