...
typedef struct VuRenderVideoBackgroundData
{
   ...
   const void* renderData;
    ...
    /**
     * \note  OpenGL ES: int* pointing to a variable holding to the texture unit ID
     *        DX11: NULL
     *        Metal: int* pointing to a variable holding to the texture unit ID
     */
...
/// \brief Set the current near/far plan to be used for the projection matrix reported in RenderState
